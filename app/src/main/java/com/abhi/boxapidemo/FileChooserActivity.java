...
public class FileChooserActivity extends ListActivity {
    ...
    public FileArrayAdapter fileArrayListAdapter;
...
//                };
    ...
    private void fill(File f) {
        ...
        this.setTitle(getString(R.string.currentDir) + "");
        ...
        try {
            for (File file : folders) {
                if (file.isDirectory() && !file.isHidden())
                    ...
                    if (!file.isHidden())
//                        if(file.getName().endsWith(Constants.XLSX) || file.getName().endsWith(Constants.XLSX) ||
//                                file.getName().endsWith(Constants.DOC) || file.getName().endsWith(Constants.DOCX) ||
//                                file.getName().endsWith(Constants.PDF) ||
//                                file.getName().endsWith(Constants.JPG) || file.getName().endsWith(Constants.JPEG) || file.getName().endsWith(Constants.PNG) ||
//                                file.getName().endsWith(Constants.PPT) || file.getName().endsWith(Constants.PPTX) ||
//                                file.getName().endsWith(Constants.JPG)){
